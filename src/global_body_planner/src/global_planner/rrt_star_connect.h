...
/*!
   This class inherits the RRTConnectClass, and modifies the extend function to
   rewire nearby states to reduce path length.
*/
...
public:
  ...
  /**
   * @brief Run the RRT*-Connect planner until the goal is found and time has
